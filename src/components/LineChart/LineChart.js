...
function LineChart() {
    ...
    useEffect(() => {
        if (data && chartRef.current) {
            ...
            // Wraps the text with a callout path of the correct size, as measured on the page.
            ...
            // Cleanup: remove the SVG when the component unmounts
            return () => {
                svg.remove();
            };
        }
    ...
    return <Box m={3}><div ref={chartRef}></div></Box>;
}
